...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookImpl.java[tags=notInPlaylistConditionProvider]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/TrackComponentFactory.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookResources.java[lines=19..-1]
----
