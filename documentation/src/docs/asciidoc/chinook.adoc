...
[source,java,options="nowrap"]
----
include::{dir-test-source-client}/is/codion/demos/chinook/ui/PanelTest.java[lines=19..-1]
----
...
NOTE: Configuration only, client with an AWS Lambda connection.
...
[source,kotlin,options="nowrap"]
----
include::{root-dir}/chinook-client-lambda/build.gradle.kts[tag=**]
----
====
...
[source,kotlin,options="nowrap"]
----
include::{root-dir}/chinook-lambda/build.gradle.kts[tag=**]
----
====
