...
** <<_coverartvalue, CoverArtValue>>

** <<_albumtagsvalue, AlbumTagsValue>>
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/CoverArtValue.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/AlbumTagsValue.java[lines=19..-1]
----
