...
:dir-source-client-common: ../../../../chinook-client-common/src/main/java
...
** <<_coverartpanelbuilder, CoverArtPanelBuilder>>

** <<_albumtagspanelbuilder, AlbumTagsPanelBuilder>>

*** Used in <<_albumeditpanel, AlbumEditPanel>>

** <<_durationpanelbuilder, DurationPanelBuilder>>
...
*** <<_trackeditcomponent, TrackEditComponent>>

* Common Table Expression

** See <<_analyticsmodel, Analytics>>

* Custom components

** See <<_preferences_ui, Preferences UI>>

* Automatic EditPanel updates

** See <<_preferenceseditpanel, PreferencesEditPanel>>
...
*** <<_customereditmodel, CustomerEditModel>>

*** <<_customereditpanel, CustomerEditPanel>>

* Multiple detail editors

*** <<_artisteditmodel, AristEditModel>>

*** <<_artisteditpanel, ArtistEditPanel>>
...
* Serialization filter logging

** <<_chinook_server, Chinook Server>> - Configuring java.util.logging from the classpath
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=customerFormatter]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookImpl.java[tags=orderByName]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/CustomerModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/CustomerEditModel.java[lines=19..-1]
----

===== CustomerEditModelTest

[source,java,options="nowrap"]
----
include::{dir-test-source-client}/is/codion/demos/chinook/model/CustomerEditModelTest.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=invoiceFormatter]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookImpl.java[tags=updateTotalsProcedure]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/InvoiceConfig.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-test-source-client}/is/codion/demos/chinook/model/InvoiceModelTest.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/InvoiceEditConfig.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=invoiceLineTotal]
----

[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=quantityValidator]
----
...
===== InvoiceLineEditConfig

[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/InvoiceLineEditConfig.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/EmployeeModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/EmployeePanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/ArtistEditModel.java[lines=19..-1]
----
...
[source,sql,options="nowrap"]
----
include::{dir-source-sql}/create_schema.sql[tags=artistTag]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=artistTag]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookImpl.java[tags=artistTag]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/GenreModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/GenrePanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/AlbumConfig.java[lines=19..-1]
----
...
[#_coverartpanelbuilder]
===== CoverArtPanelBuilder

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/CoverArtPanelBuilder.java[lines=19..-1]
----

[#_albumtagspanelbuilder]
===== AlbumTagsPanelBuilder

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/AlbumTagsPanelBuilder.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=coverFormat]
----
...
[#_durationpanelbuilder]
===== DurationPanelBuilder

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/DurationPanelBuilder.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/PlaylistModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/PlaylistEditConfig.java[lines=19..-1]
----
...
===== PlaylistTrackEditConfig

[source,java,options="nowrap"]
----
include::{dir-source-client-common}/is/codion/demos/chinook/model/common/PlaylistTrackEditConfig.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/TrackEditComponent.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/TrackSelector.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-domain-api}/is/codion/demos/chinook/domain/api/Chinook.java[tags=artistRevenue]
----

[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/domain/ChinookImpl.java[tags=artistRevenue]
----

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/model/AnalyticsModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/AnalyticsPanel.java[lines=19..-1]
----
...
Authenticating against the application instead of the database, as <<#_chinookauthenticator,ChinookAuthenticator>>
does, leaves the database with a single shared user doing everyone's work. Whatever the database would like to
do with the real identity - an audit trigger recording who changed a price, a view showing a sales
representative only their own customers - no longer has anything to go on.

A `SessionContext` puts the identity back on the connection, where SQL can read it. The server applies it
each time a connection is handed to a client and removes it again on the way back, which with a connection
pool means on every check out, so it is worth keeping cheap.

Note that this is only needed for what the database can not be told more directly: the client's user,
application and host are set as JDBC client info by the server on its own, where the database supports it.
H2 supports none of it, hence the session variable below.

[#_chinooksessioncontext]
=== ChinookSessionContext

[source,java,options="nowrap"]
----
include::{dir-source-domain}/is/codion/demos/chinook/server/ChinookSessionContext.java[lines=19..-1]
----

[#_chinooksessioncontexttest]
=== ChinookSessionContextTest

[source,java,options="nowrap"]
----
include::{dir-test-source-domain}/is/codion/demos/chinook/server/ChinookSessionContextTest.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-test-source-client}/is/codion/demos/chinook/ui/ChinookPanelsTest.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-loadtest}/is/codion/demos/chinook/client/loadtest/scenarios/ClientLogin.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/TriStateCheckBoxValue.java[lines=19..-1]
----

===== TriStateCheckBoxBuilder

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/TriStateCheckBoxBuilder.java[lines=19..-1]
----

[#_preferenceseditpanel]
...
===== PreferencesTablePanel

[source,java,options="nowrap"]
----
include::{dir-source-client}/is/codion/demos/chinook/ui/PreferencesTablePanel.java[lines=19..-1]
----
...
NOTE: Configuration only, configures the server with the chinook domain.
...
NOTE: Configuration only, configures the server with the chinook domain in a docker container.
...
[source,kotlin,options="nowrap"]
----
include::{root-dir}/chinook-server-docker/build.gradle.kts[tag=**]
----
====
...
Minimal web service for selected domain entities.
