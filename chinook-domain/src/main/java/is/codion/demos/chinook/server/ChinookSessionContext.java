...
public final class ChinookSessionContext implements SessionContext {
	...
	/**
	 * H2 session variables, being what this database offers. Oracle would set a client identifier,
	 * PostgreSQL a session level setting read back with current_setting().
	 */
